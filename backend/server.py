...
# Configure CORS
# Allow all origins for API Gateway (you can restrict this in production)
# For API Gateway HTTP API, CORS must also be configured in the API Gateway console
...
bedrock_client = boto3.client(
    ...
    region_name=os.getenv("BEDROCK_REGION", "us-east-1")  # Use us-east-1 for Nova models
)
